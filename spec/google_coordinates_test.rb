...
describe "google coordinates functionality" do
  ...
  it "returns the correct coordinates for 'Washington, DC'" do
    expect(GoogleCoordinates.location_info('Washington, DC')).to eq(['Washington, DC, USA', '38.9071923,-77.0368707'])
  end

  it "returns the correct coordinates for 'los angeles'" do
    expect(GoogleCoordinates.location_info('los angeles')).to eq(['Los Angeles, CA, USA', '34.0522342,-118.2436849'])
  end
